...
class HEALTHTRACK_APP (ctk.CTk):
    def __init__(self):
        ...
        self.btn_atualizar_pacientes = ctk.CTkButton(
            self.menu_frame, text="Atualizar Pacientes",
            text_color="#FFFFFF",
            command=self.atualizar_pacientes_btn_home,
            corner_radius=10,   # arredondado
            border_width=2,
            border_color="white",
            hover_color="#54ACF0",
        ...
        self.btn_editar_pacientes.configure(fg_color="#0B395C")
        self.btn_editar_pacientes.pack(pady=5, padx=20)
    ...
    def listar(self):
        ...
        self.lista_frame = ctk.CTkScrollableFrame(self.main_frame, width=610, height=500)
        ...
        try:
            ...
            for i, paciente in enumerate(pacientes):
                card = ctk.CTkFrame(self.lista_frame, corner_radius=12, fg_color="#E8F1FF")  # azul claro
    ...
    def janela_edicao(self):
        ...
        if not self.paciente_selecionado:
            messagebox.showwarning("Seleção Necessária", "Por favor, selecione um paciente na lista para editar os dados!")
            return
